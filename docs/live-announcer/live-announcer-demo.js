...
var LiveAnnouncerDemo = /** @class */ (function () {
    ...
    LiveAnnouncerDemo = __decorate([
        core_1.Component({selector: 'toolbar-demo',
            template: "<div> <button mat-button (click)=\"announceText('Hey Google')\">Announce Text</button> </div> ",
        }),
        __metadata("design:paramtypes", [a11y_1.LiveAnnouncer])
    ], LiveAnnouncerDemo);
