...
var DragAndDropDemo = /** @class */ (function () {
    ...
    DragAndDropDemo.prototype.drop = function (event) {
        if (event.previousContainer === event.container) {
            ...
            if (this.cloneMode) {
                drag_drop_1.copyArrayItem(event.previousContainer.data, event.container.data, event.previousIndex, event.currentIndex);
            }
            else {
